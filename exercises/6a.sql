...
--SELECT artists.name,COUNT(albums.artist_id) FROM artists INNER JOIN albums on albums.artist_id = artists.id GROUP BY artists.id ORDER BY artists.name ASC;
